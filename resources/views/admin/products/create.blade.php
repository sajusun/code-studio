<x-layouts.admin>
    <div class="space-y-6 max-w-5xl mx-auto" x-data="{ 
        step: 1,
        productType: 'web_app',
        techStack: ['Laravel 11', 'TailwindCSS', 'Vue.js'],
        newTech: '',
        addTech() {
        ...
        features: [
            { title: 'Full Source Code', desc: 'Complete unencrypted codebase included', cost: '0' },
            { title: 'Responsive Admin Panel', desc: 'Sleek dashboard layout for web & mobile', cost: '0' }
        ],
        newFeatureTitle: '',
        newFeatureDesc: '',
        newFeatureCost: '0',
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-black text-theme-main tracking-tight">Add New Product</h1>
                    <p class="text-xs text-theme-muted">Step-by-step wizard to showcase software & configure leads.</p>
                </div>
            </div>
        ...
        <form method="POST" action="{{ route('admin.products.store') }}" class="bg-theme-card p-6 md:p-8 rounded-2xl border border-theme shadow-xs space-y-6">
            ...
            <div x-show="step === 1" x-transition class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" required placeholder="e.g. Master E-commerce Admin Panel & Mobile App" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="category" placeholder="e.g. E-Commerce, SaaS, Admin Dashboard" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Price -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Base Price ($ USD) *</label>
                        <input type="number" step="0.01" name="price" value="49.00" required class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Short Description -->
                    <div class="md:col-span-2">
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Short Summary</label>
                        <textarea name="short_description" rows="2" placeholder="Brief 2-line summary for product cards..." class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary"></textarea>
                    </div>

                    <!-- Full Description -->
                    <div class="md:col-span-2">
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Full Description</label>
                        <textarea name="description" rows="5" placeholder="Detailed product breakdown, highlights, and documentation instructions..." class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary"></textarea>
                    </div>

                    <!-- Flags -->
                    <div class="md:col-span-2 flex flex-wrap gap-6 pt-2">
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" checked class="w-4 h-4 rounded text-theme-primary focus:ring-0">
                            <span class="text-xs font-bold text-theme-main">Active & Published</span>
                        </label>
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="is_featured" value="1" class="w-4 h-4 rounded text-theme-primary focus:ring-0">
            ...
            <div x-show="step === 2" x-transition class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="url" name="demo_url" placeholder="https://demo.yoursite.com" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Admin Demo URL -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Admin Demo URL</label>
                        <input type="url" name="admin_demo_url" placeholder="https://demo.yoursite.com/admin" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Admin Demo Username -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Admin Demo Username</label>
                        <input type="text" name="admin_demo_username" placeholder="admin@demo.com" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Admin Demo Password -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Admin Demo Password</label>
                        <input type="text" name="admin_demo_password" placeholder="12345678" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Video Demo URL -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Video Walkthrough (YouTube / Vimeo)</label>
                        <input type="url" name="video_url" placeholder="https://www.youtube.com/watch?v=..." class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>
                    ...
                    <div x-show="productType === 'android' || productType === 'web_app'">
                        ...
                        <input type="url" name="apk_url" placeholder="https://yoursite.com/downloads/demo.apk" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-3">
                        ...
                        <template x-for="(url, index) in screenshots" :key="index">
                            <div class="flex items-center gap-2">
                                <input type="url" :name="`screenshots[${index}]`" x-model="screenshots[index]" placeholder="https://image-url.com/screenshot.png" class="flex-1 px-4 py-2 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden">
            ...
            <div x-show="step === 3" x-transition class="space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex flex-wrap items-center gap-2 p-3 rounded-xl bg-theme-main border border-theme min-h-[50px]">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="text" x-model="newTech" @keydown.enter.prevent="addTech()" placeholder="e.g. Python, Docker, Flutter..." class="px-3 py-1 text-xs bg-transparent border-none text-theme-main focus:outline-hidden">
                ...
                <div class="space-y-4 pt-4 border-t border-theme">
                    ...
                    <div class="p-4 rounded-xl bg-theme-main/50 border border-theme space-y-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <input type="text" x-model="newFeatureTitle" placeholder="Feature Name (e.g. Push Notifications)" class="px-3 py-2 text-xs rounded-xl bg-theme-card border border-theme text-theme-main">
                            <input type="text" x-model="newFeatureDesc" placeholder="Description (e.g. Firebase FCM Integration)" class="px-3 py-2 text-xs rounded-xl bg-theme-card border border-theme text-theme-main">
                            <div class="flex gap-2">
                                <input type="number" x-model="newFeatureCost" placeholder="Extra Cost ($0 = Free)" class="w-full px-3 py-2 text-xs rounded-xl bg-theme-card border border-theme text-theme-main">
            ...
            <div x-show="step === 4" x-transition class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- WhatsApp Number -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">WhatsApp Contact Number (With Country Code)</label>
                        <input type="text" name="contact_channels[whatsapp]" placeholder="+8801700000000" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_channels[whatsapp_text]" placeholder="Hi, I am interested in your Web App software." class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Direct Email -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Direct Contact Email</label>
                        <input type="email" name="contact_channels[email]" placeholder="sales@yourdomain.com" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Phone Number -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Direct Phone Line</label>
                        <input type="text" name="contact_channels[phone]" placeholder="+8801700000000" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Fiverr Gig Profile Link -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Fiverr Gig / Profile URL</label>
                        <input type="url" name="contact_channels[fiverr]" placeholder="https://www.fiverr.com/username/gig-link" class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Upwork Profile Link -->
                    <div>
                        <label class="block text-xs font-bold text-theme-main uppercase tracking-wider mb-2">Upwork Profile / Agency URL</label>
                        <input type="url" name="contact_channels[upwork]" placeholder="https://www.upwork.com/freelancers/~..." class="w-full px-4 py-2.5 text-sm rounded-xl bg-theme-main border border-theme text-theme-main focus:outline-hidden focus:border-theme-primary">
                    </div>

                    <!-- Custom Quotes Toggle -->
                    <div class="md:col-span-2 pt-2">
                        <label class="inline-flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="allow_custom_quotes" value="1" checked class="w-5 h-5 rounded text-theme-primary focus:ring-0">
                            <div>
